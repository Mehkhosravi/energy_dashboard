// the aim of this component is to provide a simple map for testing purposes
// it is not intended to be a full-featured map component
// it uses react-leaflet for rendering the map
// and provides basic functionality for adding layers and markers   
